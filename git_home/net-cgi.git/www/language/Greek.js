...
bh_orbi_sync="Για να προσθέσετε επιπλέον δορυφόρο Orbi (δεν συμπεριλαμβανόταν στο κιτ Orbi, αλλά αγοράστηκε ξεχωριστά) στο υπάρχον δίκτυο WiFi του Orbi. Μέσα σε δύο λεπτά, πατήστε αρχικά το κουμπί <b>Sync</b> (Συγχρονισμός) στο δρομολογητή και μετά το αντίστοιχο κουμπί στον πρόσθετο δορυφόρο."
