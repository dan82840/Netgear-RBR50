...
h_attach_device="<body bgcolor=#0099cc ><P><font size=4><B>Attached Devices Help</B></font></P><p>This page shows the IP address, device name, MAC (Media Access Control) address, and connection type for each computer attached to the router. <p>To update this page and refresh the list of currently attached devices, click the <b>Refresh</b> button.<p>To manually change the new device name, click the device name.<p>To block devices from accessing your network or allow devices to access your network, click the <b>Access Control</b> link in the top right corner of this page to go to the Access Control page and make changes.</body>"
...
read_user_agreement2="(to protect your system, security updates will be automatically installed even if you uncheck this box). Read <a class=havenew onclick='show_agree_info()'>the user agreement</a> to learn more."
