...
function set_gray()
{
	...
	setDisabled ( dflag, cf.tm_type[0], cf.tm_type[1], cf.traff_dir, cf.volume_monthly_limit, cf.round_up_volume, cf.conntime_monthly_limit, cf.hour, cf.minute,  cf.day,  cf.waterMark, cf.checkBlock, cf.ampm,cf.restartCounter, cf.refresh, cf.trafficStatus, cf.wan_interface);	//cf.restartCounter, cf.refresh, cf.trafficStatus,
	if( basic_type == 1)
