...
function changeUrl()
{
	if(( apmode_flag == "1" && ap_mode == "1"))
	{
		if((dns_hijack == "1") && (this.location.hostname != apmode_get_ip && this.location.hostname.indexOf("orbilogin.net") == -1 && this.location.hostname.indexOf("orbilogin.com") == -1))
			this.location.hostname = apmode_get_ip;
	}
	else
	{
		if((dns_hijack == "1") && (this.location.hostname != lanip && this.location.hostname.indexOf("orbilogin.net") == -1 && this.location.hostname.indexOf("orbilogin.com") == -1))
			this.location.hostname = "www.orbilogin.net";
	}
}
