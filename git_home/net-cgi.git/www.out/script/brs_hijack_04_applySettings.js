function initPage()
{
	...
	if(ap_mode =="1")
	{
		if(top.location.href.indexOf("BRS_index.htm") > -1){
			if(top.location.href.indexOf("orbilogin.net") > -1){
				setTimeout("top.location.href='http://orbilogin.com/BRS_index.htm';", 100000);
			}else{
				setTimeout("top.location.href='http://orbilogin.net/BRS_index.htm';", 100000);
			}
		}else{
	...
	else
	{
		if(top.dsl_enable_flag == "1")
		{
			if(top.location.href.indexOf("BRS_index.htm") > -1){
				if(top.location.href.indexOf("orbilogin.net") > -1){
					//setTimeout("top.location.href='http://orbilogin.com/BRS_index.htm';", 10000);
					setTimeout("set_jump(1)", 20000);
				}else{
					//setTimeout("top.location.href='http://orbilogin.net/BRS_index.htm';", 10000);
			...
			if(top.location.href.indexOf("BRS_index.htm") > -1){
				if(top.location.href.indexOf("orbilogin.net") > -1){
					setTimeout("top.location.href='http://orbilogin.com/BRS_index.htm';", 60000);
				}else{
					setTimeout("top.location.href='http://orbilogin.net/BRS_index.htm';", 60000);
				}
			}else
...
function set_jump(num)
{
	...
	tHttp.onreadystatechange = function()
	{
		...
		{
			if(num == 1)
				top.location.href='http://orbilogin.com/BRS_index.htm';
			else	
				top.location.href='http://orbilogin.net/BRS_index.htm';
		} else {
			  if ( tHttp.readyState == 4 && tHttp.status == 0 )
			  {	
					if(num == 1)
						setTimeout("top.location.href='http://orbilogin.com/BRS_index.htm';", 20000);
					else
						setTimeout("top.location.href='http://orbilogin.net/BRS_index.htm';", 20000);
