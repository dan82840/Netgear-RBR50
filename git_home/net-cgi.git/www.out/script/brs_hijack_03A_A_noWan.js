...
function clickRetry()
{
	...
	/* to fix bug22377: change the refresh time from 15 seconds to 30 seconds. wan lan conflict need time to change ip address*/
        if( hijack_process == "1" )
        {
                if( location.href.indexOf("www.orbilogin.net") == -1 )
                        setTimeout("top.location.href='http://www.orbilogin.net/BRS_retry.htm';", 30000);
                else
                        setTimeout("top.location.href='http://www.orbilogin.com/BRS_retry.htm';", 30000);
        }
        else
        {
                if( location.href.indexOf("www.orbilogin.net") == -1 )
                        setTimeout("top.location.href='http://www.orbilogin.net/adv_index.htm';", 30000);
                else
                        setTimeout("top.location.href='http://www.orbilogin.com/adv_index.htm';", 30000);
        }
