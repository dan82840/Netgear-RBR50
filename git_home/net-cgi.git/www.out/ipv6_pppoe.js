function change_ipv6_pppoe_password(obj)
{
        if( obj.type == "password" )
        {
                ...
                {
                        obj.outerHTML = '<input type="text" name="ipv6_pppoe_passwd" maxlength="64" size="18" style="width: 143px" onFocus="this.select();" onKeyPress="return getkey(\'ssid\', event)" value="">';
