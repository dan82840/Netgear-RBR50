...
int is_router_domain_addr(char *httphost)
{
	if ( httphost == NULL )
		return 0;
                ...
                return 0;
	else if(strcasecmp(httphost, "orbilogin.net")==0 || strcasecmp(httphost, "www.orbilogin.net")==0)
		return 0;
	else if(strcasecmp(httphost, "www.orbilogin.com")==0 || strcasecmp(httphost, "orbilogin.com")==0)
		return 0;
