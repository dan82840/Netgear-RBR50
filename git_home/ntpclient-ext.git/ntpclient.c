...
#undef Data
	 ...
	 */
	/*
	system("[ -f /tmp/first_time ] || { "
			"touch /tmp/first_time; "
			"}");
	system("/etc/init.d/cron restart nontp");
	*/
...
int main(int argc, char *argv[]) {
	...
	while(1) {
        ...
        /*
         * Below codes seems have some problem and make ntpclient not work
         * I remove below codes as a temp method to do make it work well .
         */
//		if (!wan_conn_up() && config_match("ap_mode", "0")) {
