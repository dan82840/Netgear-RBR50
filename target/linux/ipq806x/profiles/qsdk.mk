...
define Profile/EX6200v2
       NAME:=Ex6200v2 Profile (merge minimum package set)
       PACKAGES:= \
...
define Profile/EX6200v2/Description
       Ex6200v2 package set configuration.
endef


$(eval $(call Profile,EX6200v2))
